...
ALL_GENS_DIR = "../../data_for_paper_comparison/minigpt/openai_chosen_token_and_concepts/"
MODEL_NAME = "gpt-4o-mini-2024-07-18"
OUT_DIR = "../../data_for_paper_comparison/minigpt/openai_fixed"
...
while len(raw_resp) != 0:
    ...
    with open(os.path.join(ALL_GENS_DIR, f"{entity_name}_gpt-4o-mini-2024-07-18_300_w_chosen_token_and_concepts.pkl"), "rb") as f:
        data = pickle.load(f)
