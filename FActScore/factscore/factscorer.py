...
class FactScorer(object):
    ...
    def __init__(self,
                 ...
                 data_dir=os.path.join(".cache","factscore"),
                 model_dir=os.path.join(".cache","factscore"),
                 cache_dir=os.path.join(".cache","factscore"),
                 openai_key="api.key",
        ...
        self.lm = OpenAIModel(self.model_name,
    ...
    def get_score(self,
        ...
        if atomic_facts is not None:
            ...
            if self.af_generator is None:
                self.af_generator = AtomicFactGenerator(key_path=self.openai_key,
                                                        ...
                                                        gpt3_cache_file=os.path.join(self.cache_dir, "atomicfact.pkl"))
            ...
            self.print_cost_estimates(total_words, task="atomic fact generation", model=self.model_name)
            ...
            for topic, gen in zip(topics, generations):
                ...
                sentence_to_facts[topic] = curr_afs
        ...
        self.print_cost_estimates(total_words, task="factscore evaluation", model=self.model_name)
        ...
        out = {"score": np.mean(scores),
               ...
               "sentences_to_facts": sentence_to_facts}
